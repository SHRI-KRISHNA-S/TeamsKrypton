...
import { useApp, ClubEvent, MembershipRequest } from '../context/AppContext';
...
export const Dashboards: React.FC = () => {
  ...
  return (
    <div className="space-y-8 animate-slide-up">
      {/* Welcome Banner */}
      <div className="p-6 md:p-8 rounded-3xl bg-gradient-to-r from-indigo-500 via-indigo-600 to-indigo-700 text-white shadow-xl shadow-indigo-600/10 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 relative overflow-hidden">
        ...
        <div className="space-y-1.5 relative z-10">
          ...
          <p className="text-xs text-indigo-100 font-medium">
            Portal active in <span className="underline font-bold">{currentRole.toUpperCase()}</span> clearance. Review all widgets below.
          </p>
        </div>
